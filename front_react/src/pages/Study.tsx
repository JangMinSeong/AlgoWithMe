			...
			<div className=' flex flex-wrap'>
				...
				<div className=' w-[50%] mb-10 flex flex-col '>
					...
					<div className='mr-4  font-bold flex justify-between items-center h-[28%] mb-4 rounded-2xl p-2 '>
						...
						>
							<img src={currentStudyInfo.imageUrl} alt='Bubbles' width={80} height={80} className='mr-2' />
							<a id='editImage' href='a' className={`${anchorTagCSS} absolute right-0 bottom-0`}>
								{isShowingImgEditor && <GoPencil className='w-4 opacity-20' onClick={() => setIsEditingImage(true)} />}
							</a>
						</span>
						<div className='flex text-2xl mb-2 mr-2'>
							<div className='flex items-center'>
								...
								<a id='editName' className={anchorTagCSS}>
									<GoPencil className='w-4 opacity-20' onClick={() => setIsEditingName(true)} />
								</a>
							</div>
							<div>와 함께한 지</div>
