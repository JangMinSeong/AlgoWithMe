...
public class CodeService {
  ...
  public Long createPersonalCode(Long pageId, User user) {
    Page workspace = pageRepository.findById(pageId)
        .orElseThrow(() -> new CustomException(ExceptionStatus.PAGE_NOT_FOUND));
    return personalCodeRepository.save(
  ...
  public void deletePersonalCode(Long codeId, User user) {
    PersonalCode code = personalCodeRepository.findById(codeId)
  ...
  public Mono<BOJResponse> markBOJ(MarkRequest request) {
    return reactiveRawProblemRepository.findById(request.getUid())
        ...
        .flatMap(problem -> webClient.post()
            ...
            .bodyValue(new PostBOJRequest(request.getCode(), problem.getTimeLimit().getFirst(),
                problem.getExampleList()))
            .retrieve()
  ...
  public Mono<SWEAResponse> markSWEA(MarkRequest request) {
    return reactiveRawProblemRepository.findById(request.getUid())
        ...
        .flatMap(problem -> webClient.post()
            ...
            .bodyValue(new PostSWEARequest(request.getCode(),
                problem.getTimeLimit().get(request.getLanguage().ordinal()),
                problem.getExampleList().getFirst().getProblem(),
                problem.getExampleList().getFirst().getAnswer()))
            .retrieve()
  ...
  public Mono<ProgrammersResponse> markProgrammers(MarkRequest request) {
    return reactiveRawProblemRepository.findById(request.getUid())
        ...
        .flatMap(problem -> webClient.post()
            ...
            .bodyValue(new PostProgrammersRequest(getProgrammersMain(request.getLanguage()),
