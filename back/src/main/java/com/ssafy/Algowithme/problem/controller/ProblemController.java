...
public class ProblemController {
    ...
    public ResponseEntity<ProblemByTitleResponse> getProblemByTitle(@PathVariable("title") String title) {
        return ResponseEntity.ok(problemService.getProblemByTitle(title));
    }
