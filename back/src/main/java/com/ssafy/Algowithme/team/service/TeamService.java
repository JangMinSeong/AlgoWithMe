...
public class TeamService {
  ...
  public void deleteCandidateProblem(User user, Long candidateId) {
    CandidateProblem candidateProblem = candidateProblemRepository.checkAuthCandidateProblem(
        user.getId(), candidateId);
  ...
  public InviteUrlResponse createInviteUrl(Long teamId, User user) {
    ...
    return new InviteUrlResponse(aes128Config.encryptAes(
        "team" + "/" + teamId + "/" + LocalDateTime.now()
