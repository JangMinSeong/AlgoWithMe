...
public class OpenviduController {
    ...
    public ResponseEntity<OpenviduInitiateResponse> initiateSession(@PathVariable("studyId")  String studyId) throws OpenViduJavaClientException, OpenViduHttpException {
        Session session = openVidu.createSession(new SessionProperties.Builder().customSessionId(studyId).build());
