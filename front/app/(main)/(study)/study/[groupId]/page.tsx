    ...
    <div className="flex flex-col">
      <div className=" flex flex-wrap">
        ...
        <div className=" mb-10 flex">
          ...
          {/* 파이차트 */}
          <div className="w-[33%] max-w-[560px] mb-10 flex flex-col items-center">
      ...
      <div className="flex flex-wrap">
        <div className=" mb-10 flex">
          <div className="w-[33%] min-w-24 mb-10 flex flex-col items-center mr-10">
          ...
          <div className="w-[33%] min-w-24  mb-10 flex flex-col items-center">
